...
export const inngest = new Inngest({ id: "project-mgt-server" });
...
//Inngest function to save workspace member data to database aka for adding the member in the workspace
const syncWorkspaceMemberCreation = inngest.createFunction(
  {
    id: "sync-workspace-member-from-clerk",
    triggers: [
      {
        event: "clerk/organizationInvitation.accepted",  //means new member is added in the workspace 
      },
    ],
  },
  async ({ event }) => {
