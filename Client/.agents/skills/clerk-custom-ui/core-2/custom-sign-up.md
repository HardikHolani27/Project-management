...
> This document covers the **older SDK** (`@clerk/nextjs` v5–v6, `@@clerk/react` v5–v6, `@clerk/clerk-expo` v1–v2). For the current SDK, see `core-3/custom-sign-up.md`.
...
```typescript
import { useSignUp } from '@clerk/nextjs' // or @@clerk/react, @clerk/clerk-expo
